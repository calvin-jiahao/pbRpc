...
public class PreCondition {
     ...
     *            - the first {@code %s} gets {@code errorMessageArgs[0]}, etc. Unmatched arguments will be appended to
     ...
     *
     * <pre>
     *  ServiceRegistry ServiceId Repetition Exception
     * </pre>
     *
     * @param errorMessage
     */
    public static void ServiceIdRepetition(String errorMessage) {
        throw new ServiceIdRepetitionException(errorMessage);
    }
